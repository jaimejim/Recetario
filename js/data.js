...
const RECIPES = [
    ...
    ingredientGroups: [
      {
        ...
        items: [
          ...
          '64 almejas o berberechos frescos',
...

  {
    ...
    subtitle: 'Los canelones más ricos que puedes comer. Mi madre los prepara cada vez que vamos a España. De una bandeja enorme no queda nada en uno o dos días. Confieso que yo casi nunca los hago, pero los como desde pequeño y son simplemente los mejores.',
    subtitleEn: 'The most delicious cannelloni you can eat. My mum makes them every time we go to Spain. From a giant pan nothing remains after a day or two. I have to confess, I seldom make them myself. I have eaten these since I was little, they are just the best.',
    servings: 4,
    category: 'pasta',
    page: 16,
    ingredientGroups: [
      {
        ...
        items: [
          ...
          'Bechamel: 30 g de mantequilla, 30 g de harina, 300 ml de leche, nuez moscada, sal y pimienta',
        ],
      },
    ],
    ingredientGroupsEn: [
      {
        ...
        items: [
          ...
          'Bechamel: 30 g butter, 30 g flour, 300 ml milk, nutmeg, salt and pepper',
        ],
      },
    ],
    steps: [
...

  {
    ...
    subtitle: 'La auténtica pizza napolitana, con masa casera y tomate San Marzano.',
    subtitleEn: 'The authentic Neapolitan pizza, with homemade dough and San Marzano tomatoes.',
    servings: 4,
    category: 'pasta',
    page: 17,
    ingredientGroups: [
    ...
    steps: [
      ...
      'Divide la masa en cuatro porciones. Sobre una superficie enharinada, aplana cada porción con los dedos hasta unos 30 cm de diámetro, dejando el borde un poco más grueso.',
    ...
    stepsEn: [
      ...
      'Divide the dough into four portions. On a floured surface, flatten each portion with your fingers to about 30 cm diameter, leaving the edge slightly thicker.',
...

  {
    ...
    subtitle: 'Albóndigas jugosas en salsa de tomate casera, un clásico reconfortante.',
    subtitleEn: 'Juicy meatballs in homemade tomato sauce, a comforting classic.',
    servings: 4,
    category: 'carnes',
    page: 18,
    ingredientGroups: [
...

  {
    ...
    subtitle: 'Hamburguesas de pavo con calabacín, comino y cebolleta, servidas con salsa de nata agria y sumac.',
    subtitleEn: 'Turkey burgers with zucchini, cumin, and green onion, served with a sour cream and sumac sauce.',
    servings: 4,
    category: 'carnes',
    page: 24,
    ingredientGroups: [
...

  {
    ...
    subtitle: 'El clásico de clásicos de la cocina española, jugosita por dentro y cuajada por fuera.',
    subtitleEn: 'The classic of classics in Spanish cooking, runny on the inside and set on the outside.',
    servings: 4,
    category: 'basicos',
    page: 33,
    ingredientGroups: [
...

  {
    ...
    subtitle: 'Paella de marisco donde todos los crustáceos van pelados, sin cabeza ni cáscara, para que el comensal no se manche las manos.',
    subtitleEn: 'A seafood paella where all the shellfish are peeled and shelled, so you do not get your hands dirty.',
    servings: 4,
    category: 'arroces',
    ingredientGroups: [
      {
...

  {
    ...
    subtitle: 'Risotto clásico italiano con setas secas, vino blanco y parmesano.',
    subtitleEn: 'Classic Italian risotto with dried mushrooms, white wine, and Parmesan.',
    servings: 4,
    category: 'arroces',
    ingredientGroups: [
      {
...

  {
    ...
    ingredientGroups: [
      ...
      },
      {
        name: 'Montaje',
        items: [
          '1 paquete de 400 g de láminas de lasaña fresca',
        ],
      },
    ],
    ingredientGroupsEn: [
      ...
      },
      {
        name: 'Assembly',
        items: [
          '1 pack of 400 g fresh lasagne sheets',
        ],
      },
    ],
    steps: [
...

  {
    ...
    ingredientGroups: [
      {
        ...
        items: [
          ...
          '170 g de roquefort',
          '80 g de rúcula',
          '70 g de garbanzos cocidos (opcional)',
          '1 puñado de uvas',
          'Zumo de 1 limón',
          'Zumo de 1 pomelo',
    ...
    ingredientGroupsEn: [
      {
        ...
        items: [
          ...
          '170 g Roquefort',
          '80 g rocket',
          '70 g cooked chickpeas (optional)',
          '1 handful of grapes',
          'Juice of 1 lemon',
    ...
    steps: [
      ...
      'Prepara el aliño mezclando el zumo de limón, el zumo de pomelo, el yogur, el sumac y un chorrito de aceite de oliva. Añade una pizca de sal.',
      'Para servir, trocea la rúcula con las manos, coloca encima las láminas de fruta, los garbanzos (aclarados), las uvas y el roquefort cortado en cubitos.',
      'Aliña con la salsa, decora con una rodaja de pomelo y, opcionalmente, unas gotas de glaseado de balsámico e higo por encima.',
    ],
    stepsEn: [
      'Wash and slice the apple and pears very thinly (you can use a peeler).',
      'Make the dressing by mixing the lemon juice, grapefruit juice, yogurt, sumac and a drizzle of olive oil. Add a pinch of salt.',
...

  {
    ...
    ingredientGroups: [
      {
        name: 'Ingredientes',
        items: [
          '200 g de orecchiette',
          '500 g de brócoli',
          '4 cucharaditas de aceite de oliva virgen extra',
          '1 diente de ajo',
          '1 guindilla roja',
          '40 g de anchoas en aceite (reservar el aceite)',
          'Sal al gusto',
        ],
      },
    ],
    ingredientGroupsEn: [
      {
        ...
        items: [
          ...
          '1 clove of garlic',
          '1 red chili pepper',
          '40 g anchovies in oil (reserve the oil)',
          'Salt to taste',
        ],
      },
    ],
    steps: [
      ...
      'Se corta el ajo y la guindilla en láminas finas. Se ponen en una sartén amplia con el aceite y el aceite reservado de las anchoas, y se sofríen a fuego lento sin que el ajo se queme. Se añaden las anchoas escurridas y se remueven hasta que se deshagan en el aceite, formando la base de la salsa.',
    ...
    stepsEn: [
      ...
      'Thinly slice the garlic and chili. Place in a wide pan with the oil and the reserved anchovy oil, and sauté gently, being careful not to burn the garlic. Add the drained anchovies and stir until they melt into the oil, forming the base of the sauce.',
...

  {
    ...
    steps: [
      'Pon la manita, las cortezas y, si los usas, el musetto y el rabito en abundante agua. Lleva a ebullición y cuece 1 hora.',
      'Aparte, dora las costillas en una sartén con un poco de aceite y el romero. Resérvalas calientes.',
      'Limpia la col, retira el nervio central, córtala en trozos y lávala bien. Ponla en una cazuela tapada con solo el agua que quede en las hojas y deja que se ablande.',
      'Saca la manita y las cortezas del agua, deshuesa y córtalas en trozos. En una cazuela grande, haz un sofrito de apio, zanahoria y cebolla en brunoise con mantequilla y un poco de concentrado de tomate.',
      'Cuando el sofrito esté pochado, añade los trozos de cerdo cocidos, los verzini crudos y las costillas. Mezcla bien y sube el fuego. Añade el vino tinto.',
      'Cuando el alcohol se evapore, añade la col cocida y cubre con la mitad del caldo. Baja el fuego, tapa dejando una rendija y cocina 1 hora y media. Añade caldo poco a poco si se seca demasiado.',
      'Sala y añade pimienta solo al final de la cocción. La cassoeula está lista cuando toda la carne esté tierna.',
    ],
    stepsEn: [
      'Place the trotter, rind and, if using, the snout and tail in plenty of water. Bring to the boil and cook for 1 hour.',
      'Separately, brown the ribs in a pan with a little oil and the rosemary. Keep warm.',
      'Clean the cabbage, remove the thick central rib, cut into pieces and wash well. Place in a covered pot with just the water left on the leaves and let it wilt.',
      'Remove the trotter and rind from the water, debone and cut into pieces. In a large pot, make a soffritto of celery, carrot and onion in brunoise with butter and a little tomato concentrate.',
      'Once the soffritto is soft, add the cooked pork pieces, the raw sausages and the ribs. Mix well and raise the heat. Add the red wine.',
      'When the alcohol has evaporated, add the cooked cabbage and cover with half the broth. Lower the heat, cover leaving a gap, and cook for 1.5 hours. Add broth gradually if it dries out too much.',
  ...
  {
    id: 'salviakana',
    title: 'Pollo con Salvia Crujiente',
    titleEn: 'Crispy Sage Chicken',
    subtitle: 'Pollo dorado en una sola sartén con salvia frita, aceitunas, limón en conserva y salsa de vino blanco. De Bella Table.',
    subtitleEn: 'Golden chicken in one pan with fried sage, olives, preserved lemon and white wine sauce. From Bella Table.',
    servings: 4,
    category: 'carnes',
    page: 0,
    ingredientGroups: [
      {
        name: 'Pollo y salvia',
        items: [
          '800 g de pechugas o muslos de pollo deshuesados',
      ...
      },
      {
        ...
        items: [
          ...
          '1 cdta de miel',
          '1 dl de aceitunas negras sin hueso (tipo kalamata)',
          '1-2 limones en conserva',
          '1-2 dl de nata para montar (opcional)',
        ],
      },
    ],
    ingredientGroupsEn: [
      {
        name: 'Chicken and sage',
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          '2 tsp Dijon mustard',
          '1 tsp honey',
          '1 dl pitted black olives (e.g. kalamata)',
          '1-2 preserved lemons',
          '1-2 dl heavy cream (optional)',
        ],
      },
    ],
    steps: [
      'Saca el pollo del frigorífico con antelación para que se atempere. Precalienta el horno a 180 °C.',
      'Fríe la salvia: cubre el fondo de una sartén alta apta para horno con aceite de oliva y calienta a fuego fuerte. Cuando una hoja de salvia chisporrotee al tocar el aceite, baja a fuego medio. Echa las hojas y fríe unos 15 segundos. Retira con pinzas sobre papel absorbente y espolvorea con un poco de sal.',
      'Retira parte del aceite sobrante con papel. Sube el fuego y coloca el pollo con la piel hacia abajo. Añade la mantequilla y la rama de romero. Sala por encima. Dora hasta que la piel esté crujiente y dorada. Retira a un plato con la piel hacia arriba.',
      'En la misma sartén, sofríe la chalota, el ajo y las hierbas picadas. Añade el vino blanco y reduce a la mitad. Incorpora el caldo, la mostaza y la miel. Deja hervir un momento. Si quieres la salsa cremosa, añade la nata ahora.',
      'Corta el limón en conserva en dados y añádelo junto con las aceitunas. Sazona con pimienta negra. Coloca el pollo con la piel hacia arriba sobre la salsa y mete al horno 30 minutos.',
      'Saca del horno, reparte la salvia crujiente sobre el pollo y sirve enseguida. Acompaña con ensalada de rúcula y pan crujiente, o con patatas asadas.',
    ],
    stepsEn: [
      'Take the chicken out of the fridge ahead of time to come to room temperature. Preheat the oven to 180 °C.',
      'Fry the sage: cover the bottom of a tall oven-safe pan with olive oil and heat on high. When a sage leaf sizzles on contact, lower to medium. Add the leaves and fry for about 15 seconds. Remove with tongs onto kitchen paper and sprinkle with a little salt.',
      'Blot some excess oil with paper. Raise the heat and place the chicken skin-side down. Add the butter and rosemary sprig. Season with salt. Sear until the skin is crispy and golden. Transfer to a plate skin-side up.',
      'In the same pan, sauté the shallot, garlic and chopped herbs. Add the white wine and reduce by half. Stir in the stock, mustard and honey. Let it bubble briefly. For a creamy sauce, add the cream now.',
  ...
  {
    id: 'potaje-garbanzos',
    title: 'Potaje de Garbanzos con Bacalao y Espinacas',
    titleEn: 'Chickpea Stew with Cod and Spinach',
    subtitle: 'Potaje de vigilia, servido tradicionalmente los viernes de Cuaresma en España. La prohibición religiosa de comer carne hacía del bacalao y los garbanzos el aporte proteico del plato. Uno de los más encontrados en la gastronomía de Semana Santa.',
    subtitleEn: 'A Lenten stew traditionally served on Fridays during Lent in Spain. The religious prohibition on eating meat made salt cod and chickpeas the protein of the dish. One of the most iconic dishes of Holy Week.',
    servings: 8,
    category: 'sopas',
    page: 197,
    ingredientGroups: [
      {
        name: 'Cazuela 1: garbanzos y verduras',
        items: [
          '500 g de garbanzos (peso en seco, en remojo desde la noche anterior)',
          '2,5 litros de agua',
      ...
      {
        name: 'Cazuela 2: sofrito y espinacas',
        items: [
          '2 dientes de ajo',
          'Media cebolla',
      ...
      },
      {
        ...
        items: [
          ...
          '2 huevos (opcional, cocidos aparte como guarnición)',
        ],
      },
    ],
    ingredientGroupsEn: [
      {
        name: 'Pot 1: chickpeas and vegetables',
        items: [
          '500 g chickpeas (dry weight, soaked overnight)',
          '2.5 litres water',
          '500 ml fish stock',
          '1 carrot',
          '1 leek',
      ...
      {
        name: 'Pot 2: sofrito and spinach',
        items: [
          '2 garlic cloves',
          'Half an onion',
          '60 g crushed tomato',
      ...
      },
      {
        ...
        items: [
          ...
          '2 eggs (optional, hard-boiled as garnish)',
        ],
      },
    ],
    steps: [
      'Escurrir los garbanzos del remojo. Ponerlos en una olla grande con agua abundante y el caldo de pescado.',
      'Añadir la zanahoria, el puerro y el pimiento rojo enteros (o en trozos grandes).',
      'Cocer a fuego bajo durante 2 horas hasta que los garbanzos estén tiernos. Ir espumando si hace falta.',
      'Si quieres huevos cocidos: cocerlos 12 minutos en agua con vinagre y sal. Enfriar, pelar y reservar.',
      'En paralelo, en una cazuela con aceite de oliva, echar el ajo picado con el aceite todavía frío. Subir el fuego y dorar.',
      'Añadir la cebolla bien picada. Pochar a fuego bajo unos 12 minutos con un poco de sal.',
      'Añadir el pimentón dulce, remover rápido (se quema fácil), e inmediatamente el tomate triturado. Sofreír 3 minutos.',
      'Añadir el comino si lo usas.',
      'Echar las espinacas lavadas encima. Parecen muchas pero bajan enseguida. Remover, dejar un par de minutos y reservar.',
      'Cuando los garbanzos estén listos, sacar la zanahoria, el puerro y el pimiento de la cazuela. Triturarlos con un poco de caldo de la cocción.',
      'En la cazuela grande con los garbanzos y su caldo, incorporar el sofrito con espinacas y el puré de verduras trituradas.',
      'Añadir las hebras de azafrán directamente al caldo. Se deshacen solas con el calor. Integrar bien.',
      'Dejar cocer todo junto 10 minutos a fuego suave.',
      'Si queda muy caldoso, disolver una cucharadita de maicena en agua fría y añadir.',
      'Echar el bacalao en trozos. Cocer solo 2-3 minutos, lo justo para que se haga sin deshacerse.',
      'Rectificar de sal (cuidado, el bacalao ya tiene).',
      'Servir caliente con medio huevo cocido por ración.',
    ],
    stepsEn: [
      'Drain the soaked chickpeas. Place in a large pot with plenty of water and the fish stock.',
      'Add the carrot, leek and red pepper whole (or in large pieces).',
      'Cook on low heat for 2 hours until the chickpeas are tender. Skim as needed.',
      'If you want hard-boiled eggs: cook 12 minutes in water with vinegar and salt. Cool, peel and set aside.',
      'Meanwhile, in a separate pot with olive oil, add the chopped garlic while the oil is still cold. Raise heat and brown.',
      'Add the finely chopped onion. Sweat on low heat for about 12 minutes with a little salt.',
      'Add the sweet paprika, stir quickly (it burns easily), then immediately add the crushed tomato. Fry 3 minutes.',
      'Add the cumin if using.',
      'Add the washed spinach on top. It looks like a lot but wilts quickly. Stir, leave a couple of minutes and set aside.',
      'When the chickpeas are done, remove the carrot, leek and pepper. Blend them with a little cooking broth.',
      'In the large pot with the chickpeas and broth, add the sofrito with spinach and the blended vegetable puree.',
      'Add the saffron threads directly to the broth. They dissolve on their own with the heat. Mix well.',
      'Simmer everything together for 10 minutes on low heat.',
      'If too soupy, dissolve a teaspoon of cornstarch in cold water and stir in.',
      'Add the cod pieces. Cook only 2-3 minutes, just enough so it cooks without falling apart.',
      'Adjust salt (careful, the cod is already salty).',
      'Serve hot with half a hard-boiled egg per portion.',
    ],
    tip: {
      text: 'Los garbanzos se cuecen desde el principio con agua y caldo de pescado. Las verduras (zanahoria, puerro, pimiento) se cuecen con los garbanzos y luego se trituran para dar cuerpo al caldo. El azafrán se echa directamente al caldo, sin mortero. El bacalao siempre al final: 2-3 minutos. Mejor de un día para otro.',
      author: 'Giacomo',
    },
    tipEn: {
      text: 'The chickpeas cook from the start in water and fish stock. The vegetables (carrot, leek, pepper) cook with the chickpeas then get blended to give the broth body. Saffron goes straight into the broth, no mortar needed. Cod always at the end: 2-3 minutes. Even better the next day.',
      author: 'Giacomo',
    },
  },
  {
    ...
    subtitle: 'Postre tradicional asturiano, cremoso y reconfortante. La clave es remover sin parar y el toque final de mantequilla.',
    subtitleEn: 'Traditional Asturian dessert, creamy and comforting. The key is constant stirring and a final touch of butter.',
    servings: 4,
    category: 'postres',
    page: 0,
    ingredientGroups: [
      {
        ...
        items: [
          ...
          '100 g de arroz redondo (o arborio)',
          '80 g de azúcar',
          '2 ramas de canela',
          '1 vaina de vainilla',
          'La piel de un limón',
    ...
    ingredientGroupsEn: [
      {
        ...
        items: [
          '1 litre whole milk',
          '100 g short-grain rice (or arborio)',
          '80 g sugar',
          '2 cinnamon sticks',
          '1 vanilla pod',
          'Peel of one lemon',
    ...
    steps: [
      'Ponemos la leche en un cazo con las ramas de canela, la vaina de vainilla abierta y la piel de limón. Subimos el fuego.',
      'Cuando rompa a hervir, añadimos el arroz.',
      'Cocinamos removiendo sin parar durante unos 50 minutos a fuego medio-bajo.',
      'Añadimos el azúcar y cocinamos 10 minutos más, sin dejar de remover.',
      'Añadimos la mantequilla y mezclamos bien. Este es el truco para que quede cremoso.',
      'Debe quedar un poco líquido en caliente, ya que al enfriarse espesa bastante.',
      'Retiramos la canela, el limón y la vainilla. Repartimos en cuencos y espolvoreamos canela en polvo por encima.',
    ],
    stepsEn: [
      'Place the milk in a saucepan with the cinnamon sticks, split vanilla pod and lemon peel. Bring to the boil.',
      'When it starts boiling, add the rice.',
      'Cook over medium-low heat, stirring constantly, for about 50 minutes.',
      'Add the sugar and cook for 10 more minutes, still stirring.',
      'Add the butter and mix well. This is the trick for a creamy result.',
      'It should still be slightly liquid when hot, as it thickens considerably as it cools.',
      'Remove the cinnamon, lemon peel and vanilla. Divide into bowls and dust with ground cinnamon.',
    ],
    tip: {
      text: 'Puedes usar nata en vez de mantequilla si prefieres. La canela en polvo mejor echarla justo al servir, no antes. Usa siempre leche entera para conseguir la cremosidad.',
      author: 'Kai',
    },
    tipEn: {
      text: 'You can use cream instead of butter if you prefer. Dust the cinnamon just before serving, not earlier. Always use whole milk for the best creaminess.',
      author: 'Kai',
    },
  },
  {
    id: 'falstaff-waffles',
    title: 'Gofres Falstaff',
    titleEn: 'Falstaff Waffles',
    subtitle: 'Gofres tipo Lieja con mucha mantequilla, huevos y azúcar turbinado que carameliza por fuera. Crujientes, tiernos por dentro, perfectos sin sirope. Receta de Simon Sarris.',
    subtitleEn: 'Liege-style waffles with plenty of butter, eggs and turbinado sugar that caramelizes on the outside. Crisp exterior, tender brioche-like interior, perfect without syrup. Recipe by Simon Sarris.',
    servings: '14-20 gofres',
    category: 'postres',
    page: 0,
    ingredientGroups: [
      {
        ...
        items: [
          ...
          '2 cucharadas de azúcar moreno o sirope de arce',
          '180 g de mantequilla sin sal, derretida o ablandada',
          '1-2 cucharaditas de extracto de vainilla',
          '5 o 6 huevos',
          '1 cucharada de sal',
          '480 g de harina 00 (o harina normal)',
          '160 g de azúcar turbinado u otro azúcar moreno grueso',
        ],
      },
    ],
    ingredientGroupsEn: [
      {
        ...
        items: [
          ...
          '180 g unsalted butter, melted or softened',
          '1-2 tsp vanilla extract',
          '5 or 6 eggs',
          '1 tbsp salt',
          '480 g "00" flour (or all-purpose)',
          '160 g turbinado sugar, or other coarse brown sugar',
        ],
      },
    ],
    steps: [
      'Calentar la leche (microondas o cazo) y mezclar con la levadura en un bol grande. Añadir las 2 cucharadas de azúcar moreno o sirope de arce. Dejar reposar 10 minutos en un sitio templado.',
      'Mientras tanto, derretir o ablandar la mantequilla.',
      'Pasados los 10 minutos, añadir la mantequilla, los huevos y la vainilla al bol.',
      'Añadir la sal y la harina. Si usas amasadora (gancho), mezclar unos minutos hasta obtener una masa amarilla uniforme, tipo pasta.',
      'Tapar y dejar reposar 45 minutos a 1 hora en un sitio templado. No esperes que suba mucho; con esta masa pesada verás más un "abultamiento" que una subida.',
      'Justo antes de hacer los gofres, añadir el azúcar turbinado y mezclar sin integrar del todo. Que queden trozos visibles: así carameliza por fuera.',
      'Encender la gofrera. Poner porciones de masa sin engrasar la plancha. Mejor pequeños, que los bordes quedan más bonitos.',
      'Sacar con palillos de madera. Servir templados o fríos.',
    ],
    stepsEn: [
      'Warm the milk (microwave or stovetop) and mix with the yeast in a large bowl. Add the 2 tbsp of brown sugar or maple syrup. Let sit in a warm spot for 10 minutes.',
      'Meanwhile, melt or soften the butter.',
      'After 10 minutes, add the butter, eggs and vanilla extract to the bowl.',
      'Add the salt and flour. If using a stand mixer with a dough hook, mix for a few minutes until you get a uniform paste-like yellow dough.',
      'Cover and let sit for 45 minutes to an hour in a warm place. Don\'t expect a big rise; with this heavy dough you\'ll see more of a "bulge" than a rise.',
      'Just before making the waffles, add the turbinado sugar and mix without fully incorporating. Leave visible chunks: this is what caramelizes on the outside.',
      'Heat the waffle iron. Place blobs of dough without greasing the iron. Smaller is better, the edges come out cuter.',
      'Remove with wooden chopsticks. Serve warm or cold.',
    ],
    tip: {
      text: 'La harina 00 da una textura más suave tipo bollería. El azúcar turbinado es clave: no lo mezcles del todo, que caramelice por fuera. Con 5 huevos enteros quedan más ligeros; con 6 más densos pero buenísimos mojados en café. Se pueden preparar la noche anterior en la nevera, pero la masa queda muy dura: mejor estirar y cortar.',
      author: 'Kai',
    },
    tipEn: {
      text: '"00" flour gives a softer, more pastry-like texture. Turbinado sugar is key: don\'t fully mix it in, let it caramelize on the outside. 5 whole eggs makes them lighter; 6 makes them denser but excellent dipped in coffee. Can be overnighted in the fridge, but the dough gets very tough: better to roll out and cut.',
      author: 'Kai',
    },
  },
...

  {
    ...
    steps: [
      'Precalentar el horno a 180 °C. Colocar los calabacines y la cebolla en una bandeja. Regar con aceite de oliva.',
      'Asar unos 40 minutos hasta que estén bien dorados y tiernos. Reservar el agua que sueltan.',
    ...
    stepsEn: [
      'Preheat the oven to 180 °C. Place the courgettes and onion on a baking tray. Drizzle with olive oil.',
      'Roast for about 40 minutes until well browned and tender. Reserve the liquid they release.',
    ...
    tip: {
      text: 'El truco es asar bien las verduras: unos 40 minutos a 180 °C. El calabacín suelta mucha agua al horno, no la tires, va a la crema. La levadura de cerveza aporta umami sin que se note. Receta de Nacho Lozano (Chef de Familia).',
      author: 'Kai',
    },
    tipEn: {
      text: 'The trick is roasting the vegetables properly: about 40 minutes at 180 °C. The courgettes release a lot of water in the oven; don\'t discard it, it goes into the cream. Brewer\'s yeast adds umami without being noticeable. Nacho Lozano\'s recipe (Chef de Familia).',
      author: 'Kai',
    },
  },

  {
    id: 'patatas-riojana-costilla',
    title: 'Patatas a la Riojana con Costilla',
    titleEn: 'Riojan Potatoes with Lamb Ribs',
    subtitle: 'Guiso tradicional de La Rioja con patatas cascadas, chorizo picante, pimiento choricero y costilla de cordero. Receta de Karlos Arguiñano.',
    subtitleEn: 'Traditional stew from La Rioja with broken potatoes, spicy chorizo, choricero pepper and lamb ribs. Karlos Arguiñano\'s recipe.',
    servings: 4,
    category: 'sopas',
    page: 0,
    ingredientGroups: [
      {
        ...
        items: [
          '1 kg de patatas',
          '200 g de costilla de cordero, cortada en 4 trozos',
          '190 g de chorizo picante, en rodajas',
          '1 cebolleta, picada',
          '1 pimiento verde, picado',
          '1 pimiento choricero (sin pepitas, cortado en 4)',
    ...
    ingredientGroupsEn: [
      {
        ...
        items: [
          '1 kg potatoes',
          '200 g lamb ribs, cut into 4 pieces',
          '190 g spicy chorizo, sliced',
          '1 spring onion, chopped',
          '1 green pepper, chopped',
          '1 choricero pepper (deseeded, cut in 4)',
    ...
    steps: [
      'Picar los ajos, la cebolleta y el pimiento verde. Ponerlos en una cazuela con un chorro de aceite y rehogar.',
      'Cortar la costilla en 4 trozos y añadirlos a la cazuela. Cortar el chorizo en rodajas y agregarlo.',
      'Pelar las patatas y cascarlas (romperlas con un golpe de cuchillo, no cortar limpio). Añadirlas a la cazuela y remover para que no se peguen.',
      'Retirar las pepitas del pimiento choricero, cortarlo en 4 trozos e incorporarlo. Añadir la hoja de laurel, el pimentón y salar.',
      'Cubrir con agua y cocinar a fuego medio 25-30 minutos.',
      'Comprobar el punto de la carne. Si estuviera dura, dejar 15 minutos más.',
      'Servir caliente.',
    ],
    stepsEn: [
      'Chop the garlic, spring onion and green pepper. Place in a casserole with a splash of oil and sauté.',
      'Cut the ribs into 4 pieces and add to the pot. Slice the chorizo and add it.',
      'Peel the potatoes and break them (crack with a knife blow, don\'t cut cleanly). Add to the pot and stir so they don\'t stick.',
      'Deseed the choricero pepper, cut into 4 pieces and add. Add the bay leaf, paprika and season with salt.',
      'Cover with water and cook over medium heat for 25-30 minutes.',
      'Check the meat. If still tough, cook for another 15 minutes.',
      'Serve hot.',
    ],
    tip: {
      text: 'Las patatas se cascan, no se cortan: el golpe de cuchillo deja bordes irregulares que sueltan almidón y espesan el caldo. Si queda muy caldoso, aplasta algunas patatas con un tenedor y devuélvelas a la cazuela. Receta de Karlos Arguiñano.',
      author: 'Kai',
    },
    tipEn: {
      text: 'Break the potatoes, don\'t cut them: the knife blow leaves irregular edges that release starch and thicken the broth. If too soupy, mash a few potatoes with a fork and return them to the pot. Karlos Arguiñano\'s recipe.',
      author: 'Kai',
    },
  },

  {
    ...
    titleEn: 'Vegetable Purée',
    subtitle: 'Un puré cremoso y saludable, repleto de nutrientes y vitaminas. Ideal para entrar en calor cuando empieza el frío.',
    subtitleEn: 'A creamy, healthy purée, packed with nutrients and vitamins. Ideal for warming up when the cold sets in.',
    servings: 4,
    category: 'verduras',
    ingredientGroups: [
      {
        ...
        items: [
          ...
          '500 ml de agua',
          '4 quesitos en porciones (opcional)',
          'Nuez moscada',
          'Sal',
    ...
    steps: [
      'Limpia el puerro descartando la parte verde y las raíces. Hazle un corte en cruz para lavarlo bien y córtalo en rodajas. Lava y pela las zanahorias, las patatas, los nabos y la calabaza, y trocéalo todo a grandes rasgos.',
      'En una olla alta, calienta el aceite y rehoga todas las verduras con un poco de sal a fuego alto durante 15 minutos.',
      'Añade el medio litro de agua, salpimenta y sigue la cocción a fuego medio otros 20 a 25 minutos, hasta que las verduras estén tiernas.',
      'Incorpora los quesitos (o un chorrito de crema o leche al gusto) y ralla un poco de nuez moscada.',
      'Tritura todo con la batidora de mano hasta obtener una textura homogénea y cremosa.',
      'Sirve bien caliente, acompañado de picatostes.',
    ],
    stepsEn: [
      'Clean the leek, discarding the green part and the roots. Make a cross-shaped cut to wash it well and slice it. Wash and peel the carrots, potatoes, turnips, and squash, and roughly chop everything.',
      'In a tall pot, heat the oil and sauté all the vegetables with a little salt over high heat for 15 minutes.',
      'Add the half litre of water, season with salt and pepper, and continue cooking over medium heat for another 20 to 25 minutes, until the vegetables are tender.',
      'Stir in the cheese portions (or a splash of cream or milk to taste) and grate in a little nutmeg.',
      'Blend everything with a hand blender until you get a smooth, creamy texture.',
      'Serve piping hot, with croutons on the side.',
    ],
    tip: {
      text: 'Los quesitos son opcionales: a veces queda mejor con un poco de crema o leche al gusto. La nuez moscada rallada al final le da un toque especial.',
      author: 'Consejo de Jaime',
    },
    tipEn: {
      text: 'The cheese portions are optional: sometimes it turns out better with a little cream or milk to taste. A grating of nutmeg at the end gives it a special touch.',
      author: 'Jaime\'s tip',
    },
  },

  {
    ...
    ingredientGroups: [
      ...
      {
        name: 'Adobo (opcional, para untar)',
        items: [
      ...
      {
        name: 'Chimichurri (opcional, para mojar)',
        items: [
          'Perejil fresco picado (un buen puñado)',
          '3 dientes de ajo picados',
          '2 cucharadas de orégano seco',
          '1 cucharadita de ají molido o guindilla en copos',
      ...
      {
        name: 'Salsa de soja y jengibre (opcional, para mojar)',
        items: [
          '3 cucharadas de salsa de soja',
          '1 cucharada de vinagre de arroz',
          '1 trozo de jengibre fresco rallado (2 a 3 cm)',
          '1 diente de ajo picado',
          '1 cucharadita de aceite de sésamo',
          '1 cebolleta picada fina',
          '1 cucharadita de azúcar (opcional)',
          'Aceite de guindilla al gusto (opcional)',
        ],
      },
    ],
    ingredientGroupsEn: [
      ...
      {
        name: 'Marinade (optional, to rub on)',
        items: [
      ...
      {
        name: 'Chimichurri (optional, for dipping)',
        items: [
          'Fresh parsley, chopped (a good handful)',
          '3 cloves of garlic, minced',
          '2 tbsp dried oregano',
          '1 tsp chilli flakes or ají molido',
      ...
      {
        name: 'Soy and ginger sauce (optional, for dipping)',
        items: [
          '3 tbsp soy sauce',
          '1 tbsp rice vinegar',
          '1 piece of fresh ginger, grated (2 to 3 cm)',
    ...
    steps: [
      ...
      'Prepara la barbacoa de gas en dos zonas: una directa a fuego fuerte para sellar y otra indirecta con los quemadores apagados y la tapa cerrada a 180 a 200 °C. Coloca la parte más fina de la pieza hacia la zona menos caliente, porque se hace antes. Ten a mano un termómetro de sonda: en este corte lo que manda es la temperatura, no el reloj.',
      'Sella la pieza en la zona directa hasta formar costra: 2 a 4 minutos con la cara de la grasa hacia abajo primero y 2 a 3 minutos la cara magra. Vigila las llamaradas de la grasa y no la selles de más; el vacío es fino y se pasa enseguida.',
      'Termina en la zona indirecta con la tapa cerrada, guiándote SIEMPRE por la sonda clavada en la parte más gruesa (o al tacto: si al apretar asoma jugo rojo, está poco hecho). El tiempo depende del grosor, no del peso: una pieza fina de ~1 kg suele llegar al punto casi solo con el sellado, o necesita 2 a 4 minutos más; una de ~2 kg, más gruesa, pide 6 a 12 minutos de indirecto. Está muy atento porque este corte se pasa enseguida: en cuanto el termómetro se acerque a tu punto (45 °C), retírala.',
      'Retira la carne unos 3 °C antes del punto deseado, porque seguirá subiendo al reposar. Escala: poco hecho 40 °C, punto menos 45 °C, al punto 50 °C, punto más 55 °C, muy hecho 60 °C. Para un vacío jugoso lo ideal es no pasar de 50 °C.',
      'Deja reposar tapado en papel albal (aluminio) sin envolver apretado para no reblandecer la costra: unos 5 a 10 minutos una pieza de ~1 kg, y 15 minutos o más una pieza grande de ~2 kg.',
    ...
    stepsEn: [
      ...
      'Set up the gas barbecue in two zones: a direct zone on high heat for searing and an indirect zone with the burners off and the lid closed at 180 to 200 °C. Put the thinner end of the piece towards the cooler zone, as it cooks first. Keep a probe thermometer to hand: with this cut what matters is the temperature, not the clock.',
      'Sear the piece over the direct zone until a crust forms: 2 to 4 minutes fat side down first and 2 to 3 minutes on the lean side. Watch for fat flare-ups and do not over-sear it; flap is thin and overcooks quickly.',
      'Finish in the indirect zone with the lid closed, always going by the probe pushed into the thickest part (or by touch: if pressing brings red juice to the surface, it is still rare). Time depends on thickness, not weight: a thin ~1 kg piece often reaches your point almost from the sear alone, or needs 2 to 4 minutes more; a thicker ~2 kg piece needs 6 to 12 minutes of indirect heat. Stay very attentive because this cut overcooks fast: as soon as the thermometer nears your target (45 °C), pull it off.',
      'Pull the meat off about 3 °C before your target, as it keeps rising while it rests. Scale: rare 40 °C, medium-rare 45 °C, medium 50 °C, medium-well 55 °C, well done 60 °C. For a juicy flap, best not to go past 50 °C.',
      'Rest it covered with aluminium foil, without wrapping it tightly so the crust does not go soft: about 5 to 10 minutes for a ~1 kg piece, and 15 minutes or more for a large ~2 kg piece.',
      ...
      'Dipping sauces (optional, in case you do not marinate the meat): for the chimichurri, hydrate the garlic, oregano and salt in the hot water, add the vinegar and oil, let it rest 15 minutes and stir in the parsley (better if it macerates for a couple of hours). For the soy and ginger one, mix all the ingredients in a bowl and adjust the heat and sugar to taste.',
    ],
    tip: {
      text: 'El vacío es fibroso: para que quede tierno, la clave es cortarlo muy fino a contrahebra. En una pieza fina, el sellado inverso (primero indirecto suave y un golpe de fuego fuerte al final) da más margen para controlar el punto.',
      author: 'Truco de Jaime',
    },
    tipEn: {
      text: 'Flap is fibrous: for tenderness, the key is to slice it very thin across the grain. On a thin piece, a reverse sear (gentle indirect heat first, then a blast of high heat at the end) leaves more margin to control the doneness.',
      author: 'Jaime\'s tip',
    },
  },
];
