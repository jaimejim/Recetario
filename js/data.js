...
const RECIPES = [
...

  {
    ...
    subtitle: 'Potaje típico de Semana Santa. Fuentes: libro de cocina (p. 197) y CovalPlato (YouTube).',
    subtitleEn: 'Traditional Holy Week stew. Sources: family cookbook (p. 197) and CovalPlato (YouTube).',
    servings: 8,
    category: 'sopas',
    page: 197,
    ingredientGroups: [
      ...
      {
        name: 'Bolitas de bacalao (opcional, del libro)',
        items: [
          '2 trozos de bacalao (desalado y desmigado, sin cocer)',
          '1 diente de ajo',
    ...
    ingredientGroupsEn: [
      ...
      {
        name: 'Cod fritters (optional, from the book)',
        items: [
          '2 pieces of cod (desalted and flaked, uncooked)',
          '1 garlic clove',
    ...
    steps: [
      'Poner los garbanzos en remojo la noche anterior con agua y un poco de sal.',
      'Cocer los garbanzos en abundante agua con sal hasta que estén tiernos (1,5-2 horas según el garbanzo). Escurrir y reservar.',
      'Picar la zanahoria, el puerro, el pimiento rojo, la cebolla y los ajos en trozos pequeños.',
      'En una olla con aceite de oliva, pochar las verduras a fuego medio hasta que estén blandas.',
      'Añadir el tomate triturado y sofreír unos minutos.',
      'Agregar el pimentón dulce y el comino, remover rápido para que no se queme.',
      'Añadir las hebras de azafrán y el litro de caldo de pescado. Dejar hervir.',
      'Incorporar los garbanzos cocidos y dejar cocer todo junto 15-20 minutos para que se integren los sabores.',
      'Cortar el bacalao desalado en trozos y añadirlo a la olla. Cocer 5-8 minutos (no más, para que no se deshaga).',
      'Añadir las espinacas lavadas al final, se hacen en 2-3 minutos.',
      'Si queda muy caldoso, disolver un poco de maicena en agua fría y añadir para espesar.',
      'Rectificar de sal y servir caliente.',
    ],
    stepsEn: [
      'Soak the chickpeas overnight in water with a little salt.',
      'Cook the chickpeas in plenty of salted water until tender (1.5-2 hours depending on the chickpea). Drain and set aside.',
      'Chop the carrot, leek, red pepper, onion and garlic into small pieces.',
      'In a pot with olive oil, sweat the vegetables over medium heat until soft.',
      'Add the crushed tomato and fry for a few minutes.',
      'Add the sweet paprika and cumin, stir quickly so it does not burn.',
      'Add the saffron threads and the litre of fish stock. Bring to a boil.',
      'Add the cooked chickpeas and simmer together for 15-20 minutes so the flavours meld.',
      'Cut the desalted cod into pieces and add to the pot. Cook 5-8 minutes (no more, so it does not fall apart).',
      'Add the washed spinach at the end, it cooks in 2-3 minutes.',
      'If too soupy, dissolve a little cornstarch in cold water and stir in to thicken.',
      'Adjust salt and serve hot.',
    ],
    tip: {
      text: 'Opcional: mezclar el bacalao desmigado con el ajo picado, la cebolla, el huevo y el pan rallado. Formar bolitas, rebozar en harina y freír. Añadir al potaje en los últimos minutos de cocción.',
      author: 'Bolitas de bacalao (del libro)',
    },
    tipEn: {
      text: 'Optional: mix the flaked cod with chopped garlic, onion, egg and breadcrumbs. Shape into small balls, coat in flour and fry. Add to the stew in the last few minutes of cooking.',
      author: 'Cod fritters (from the book)',
    },
  },
];
