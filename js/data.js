...
const RECIPES = [
...

  {
    ...
    steps: [
      ...
      'Pasa el vacío a la zona indirecta con la tapa cerrada y guíate por la sonda clavada en el centro de la parte más gruesa. En un corte fino como este bastan unos 10-15 minutos. Lo mejor es guiarse por el termómetro (45 °C) o al tacto: si al apretarlo aparece jugo rojo en la superficie.',
      ...
      'Deja reposar 10 a 15 minutos tapado en papel albal (aluminio) sin envolver apretado para no reblandecer la costra.',
    ...
    stepsEn: [
      ...
      'Move the flap to the indirect zone with the lid closed and go by the probe pushed into the centre of the thickest part. A thin cut like this only needs about 10 to 15 minutes. It is best to go by the thermometer (45 °C) or by touch: if pressing it brings red juice to the surface.',
      ...
      'Rest for 10 to 15 minutes covered with aluminium foil, without wrapping it tightly so the crust does not go soft.',
