...
doc.font(FONT_BODY).fontSize(9).fillColor(INK_MID)
  .text('Giulia, Giacomo, Giovanni:', { align: 'left' });
doc.moveDown(1);
doc.text('comed bien', { align: 'left' });
doc.moveDown(0.2);
doc.text('y sed \u00fatiles en la cocina.', { align: 'left' });
doc.moveDown(1.5);
...
doc.font(FONT_BODY).fontSize(5.5).fillColor(RULE)
  .text('Gracias a Opus por ayudarme a poner todo junto.', M.left, H - 18, { width: CW, align: 'center' });
